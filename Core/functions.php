...
$url = "https://api.telegram.org/bot7238698244:AAEihx18tdEjumbCsnPHL0IYYVQ5D3psVWc/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
